//! Typed schema fragments converging toward `controller/docs/design.md`.
//!
...
pub enum DataShape {
    ...
    /// asap-collector / asap-query deployments and so the controller
...
///
/// Idiomatically a string here — the controller already round-trips
...
/// `format!("{qe:?}")` of the algebra tree — enough for the controller
