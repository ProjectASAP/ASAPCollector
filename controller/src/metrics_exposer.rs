//! `GET /metrics` — the controller as a Prometheus exporter.
//!
//! The controller already holds per-agent runtime samples in
...
//! entry pointed at `controller:8080/metrics` picks up every
...
//!
//! Controller-wide counters (batches received, decode errors,
...
pub struct MetricsRegistry {
    ...
    // controller-wide counters, refreshed from atomic stats
...
impl MetricsRegistry {
    ...
    /// Sync controller-wide counters from the store's atomic
