...
#      `deploy/mvp-singlenode/docker-compose/mvp-multi-stage.yml`.
#
...
#      `deploy/mvp-singlenode/configs/mvp-workload.yaml` exercise:
...
#
# Usage:
#   bash deploy/mvp-singlenode/scripts/run_mvp_demo.sh                      # both modes (default)
#   bash deploy/mvp-singlenode/scripts/run_mvp_demo.sh --mode baseline      # baseline only
#   bash deploy/mvp-singlenode/scripts/run_mvp_demo.sh --mode asap          # asap only
#   bash deploy/mvp-singlenode/scripts/run_mvp_demo.sh --mode both          # explicit
#
...
# Host-published ports (see deploy/mvp-singlenode/docker-compose/base.yml).
...
# sidecar (see deploy/mvp-singlenode/docker-compose/mvp-thanos-archive.yml). The
...
capture_emitted_configs() {
    ...
    if [[ -f "${REPO_ROOT}/deploy/mvp-singlenode/configs/asap-otel-gateway-mvp-placeholder.yaml" ]]; then
        cp "${REPO_ROOT}/deploy/mvp-singlenode/configs/asap-otel-gateway-mvp-placeholder.yaml" \
...
measure_phase() {
    ...
    # `deploy/mvp-singlenode/configs/backend-streaming.yaml`). With the previous
