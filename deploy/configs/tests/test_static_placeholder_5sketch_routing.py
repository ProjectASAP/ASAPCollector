...
`deploy/configs/asap-otel-agent-b6-asap-single-sketch.yaml` (the
default `AGENT_CONFIG_A` / `AGENT_CONFIG_B` in
`deploy/docker-compose/mvp-multi-stage.yml`) is caught by the smoke
...
Run:
    python3 deploy/configs/tests/test_static_placeholder_5sketch_routing.py
"""
