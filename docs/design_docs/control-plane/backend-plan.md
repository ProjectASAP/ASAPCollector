...
Developer guides:
[runtime plan publication](https://github.com/ProjectASAP/ASAPQuery-backend/blob/main/docs/developer_docs/control-plane/plan-publication.md) and
[BackendPlan installation](https://github.com/ProjectASAP/ASAPQuery-backend/blob/main/docs/developer_docs/query-engine/backend-plan-runtime.md).
