...
Developer guide:
[Summary storage and series identity](https://github.com/ProjectASAP/ASAPQuery-backend/blob/main/docs/developer_docs/summary-store-engine/implementation.md).
...
[series identity](../cross-cutting/summary-series-id.md).
