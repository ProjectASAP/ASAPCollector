...
// SeriesID returns the seriesid associated with this HistogramDataPoint.
func (ms HistogramDataPoint) SeriesID() uint64 {
	return ms.orig.SeriesID
}

// SetSeriesID replaces the seriesid associated with this HistogramDataPoint.
func (ms HistogramDataPoint) SetSeriesID(v uint64) {
	ms.state.AssertMutable()
	ms.orig.SeriesID = v
}
