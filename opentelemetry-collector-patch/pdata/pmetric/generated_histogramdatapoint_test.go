...
func TestHistogramDataPoint_SeriesID(t *testing.T) {
	ms := NewHistogramDataPoint()
	...
	sharedState := internal.NewState()
	sharedState.MarkReadOnly()
	assert.Panics(t, func() { newHistogramDataPoint(internal.NewHistogramDataPoint(), sharedState).SetSeriesID(uint64(13)) })
}
