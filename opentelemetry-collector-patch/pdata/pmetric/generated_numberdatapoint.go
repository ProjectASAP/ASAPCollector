...
// SeriesID returns the seriesid associated with this NumberDataPoint.
func (ms NumberDataPoint) SeriesID() uint64 {
	return ms.orig.SeriesID
}

// SetSeriesID replaces the seriesid associated with this NumberDataPoint.
func (ms NumberDataPoint) SetSeriesID(v uint64) {
	ms.state.AssertMutable()
	ms.orig.SeriesID = v
}
