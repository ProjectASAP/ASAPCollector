...
func TestExponentialHistogramDataPoint_SeriesID(t *testing.T) {
	ms := NewExponentialHistogramDataPoint()
	...
	sharedState.MarkReadOnly()
	assert.Panics(t, func() {
		newExponentialHistogramDataPoint(internal.NewExponentialHistogramDataPoint(), sharedState).SetSeriesID(uint64(13))
	})
}
