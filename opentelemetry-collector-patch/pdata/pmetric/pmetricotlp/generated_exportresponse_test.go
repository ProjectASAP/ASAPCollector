...
func TestExportResponse_SeriesAssignments(t *testing.T) {
	ms := NewExportResponse()
	assert.Equal(t, NewSeriesAssignmentSlice(), ms.SeriesAssignments())
	ms.orig.SeriesAssignments = internal.GenTestSeriesAssignmentPtrSlice()
	assert.Equal(t, generateTestSeriesAssignmentSlice(), ms.SeriesAssignments())
}
