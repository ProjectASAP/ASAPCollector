...
// SeriesAssignments returns the SeriesAssignments associated with this ExportResponse.
func (ms ExportResponse) SeriesAssignments() SeriesAssignmentSlice {
	return newSeriesAssignmentSlice(&ms.orig.SeriesAssignments, ms.state)
}
