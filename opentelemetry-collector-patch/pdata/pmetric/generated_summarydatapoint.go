...
// SeriesID returns the seriesid associated with this SummaryDataPoint.
func (ms SummaryDataPoint) SeriesID() uint64 {
	return ms.orig.SeriesID
}

// SetSeriesID replaces the seriesid associated with this SummaryDataPoint.
func (ms SummaryDataPoint) SetSeriesID(v uint64) {
	ms.state.AssertMutable()
	ms.orig.SeriesID = v
}
