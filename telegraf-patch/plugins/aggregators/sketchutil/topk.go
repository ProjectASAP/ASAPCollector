...
// structure inspired by github.com/Froot-NetSys/promsketch.
...
// For efficiency we linearly scan to find an existing key (as in promsketch)
// to avoid auxiliary maps and their GC overhead.
