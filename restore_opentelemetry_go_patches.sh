#!/usr/bin/env bash
# Stage opentelemetry-go-patch/ onto the opentelemetry-go submodule's
# working tree. Same source-of-truth-in-main / overlay-onto-submodule
# pattern as the collector and contrib restore scripts. Revived after
# cleanup PR #363.
set -euo pipefail
