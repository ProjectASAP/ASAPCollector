...
func AssertEqual[T Datatypes](t TestingT, expected, actual T, opts ...Option) bool {
	...
	case metricdata.DDSketch[int64]:
		r = equalDDSketch(e, aIface.(metricdata.DDSketch[int64]), cfg)
	case metricdata.DDSketch[float64]:
		r = equalDDSketch(e, aIface.(metricdata.DDSketch[float64]), cfg)
	case metricdata.DDSketchDataPoint[int64]:
...
func AssertHasAttributes[T Datatypes](t TestingT, actual T, attrs ...attribute.KeyValue) bool {
	...
	case metricdata.Gauge[float64]:
		reasons = hasAttributesGauge(e, attrs...)
	case metricdata.DDSketch[int64]:
		reasons = hasAttributesDDSketch(e, attrs...)
	case metricdata.DDSketch[float64]:
		reasons = hasAttributesDDSketch(e, attrs...)
	case metricdata.DDSketchDataPoint[int64]:
