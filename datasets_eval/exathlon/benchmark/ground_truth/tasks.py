...
ACCEPTED_GT_QUERIES: tuple[str, ...] = ("Q1", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q1_KLL")  # Q1_KLL
...
def run_ground_truth_task(
    ...
    elif query_id == "Q1_KLL":  # Q1_KLL
        from ground_truth.q1 import compute_q1_kll_exact  # Q1_KLL
        compute_q1_kll_exact(file_tag, output_dir, chunksize)  # Q1_KLL
    else:
