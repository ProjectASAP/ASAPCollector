...
ANALYSIS_ROOT = Path(__file__).resolve().parent.parent   # debs/analysis/
DEBS_ROOT = ANALYSIS_ROOT.parent                         # debs/  (data/ and data_filtered/ live here)
...
def results_dir() -> Path:
    return ANALYSIS_ROOT / "results" / _dataset_subdir
