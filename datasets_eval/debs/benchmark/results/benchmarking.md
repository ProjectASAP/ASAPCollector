...
|---|---|
| Day | `08-11-21` |
| Dataset | `data_filtered` (Q1, Q4, Q5; starts at **09:00 CET**); `data/` (Q3, Q6 — full feed) |
...
| Window size | Q1/Q3/Q4/Q5/Q6: 5-min tumbling |
...
> **Note:** HLL with precision 14 achieves near-perfect cardinality estimates. Max relative error never exceeds 0.13% (vs 2% threshold). This query passes with the most headroom of any evaluated query.
