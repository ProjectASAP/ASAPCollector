...
|---|---|
| Day | `08-11-21` |
| Dataset | `data_filtered` (Q1, Q4; starts at **09:00 CET**); `data/` (Q3 — full feed) |
| Q1, Q4 | `sketch-finance`, `--accuracy-minutes 60`, `--batch-size 50`, paced (speed 1×), `accuracy_sla=0.01` |
...
| Window size | Q1/Q3/Q4: 5-min tumbling |
...
> **Note:** DDSketch p0/p100 (min/max) are essentially exact on this data. The first window is 0.9997 (one symbol at a boundary), every subsequent window is perfect. This query passes with the widest margin of any evaluated query.
