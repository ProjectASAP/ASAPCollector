...
| Non-statistical queries (Q2, Q9) | `throughput`, full day, `--batch-size 5000`, max speed |
...
Non-statistical queries (Q2, Q9) use a NOP collector — no sketch, no accuracy evaluation.
