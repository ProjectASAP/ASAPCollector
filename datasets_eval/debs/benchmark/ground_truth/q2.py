...
def run_q2_only(day: str, output_root: Path, chunksize: int) -> None:
    ...
    dataframe, _ = timed_load("Q2", day_tag, csv_path, load_filtered_day, chunksize)
    if dataframe.empty:
...
def run_q1q2(day: str, output_root: Path, chunksize: int) -> None:
    day_tag = day_tag_from_arg(day)
    ...
    dataframe, _ = timed_load("Q1Q2", day_tag, csv_path, load_filtered_day, chunksize)
    if dataframe.empty:
