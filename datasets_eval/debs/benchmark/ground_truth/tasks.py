...
def run_ground_truth_task(
    ...
    if query_id == "Q1":
        ...
        run_q5(day, output_dir, chunksize, max_event_minutes=max_event_minutes)
    elif query_id == "Q6":
        from ground_truth.q6 import run_q6

        run_q6(day, output_dir, chunksize, max_event_minutes=max_event_minutes)
    elif query_id == "Q7":
        from ground_truth.q7 import run_q7

        run_q7(day, output_dir, chunksize, max_event_minutes=max_event_minutes)
    elif query_id == "Q8":
        from ground_truth.q8 import run_q8

        run_q8(day, output_dir, chunksize, max_event_minutes=max_event_minutes)
    else:
