module github.com/open-telemetry/opentelemetry-collector-contrib/processor/gorillas3processor
...
// to opentelemetry-collector-contrib/processor/gorillas3processor.
