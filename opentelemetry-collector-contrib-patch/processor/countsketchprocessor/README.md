...
The CountSketch processor (`countsketchprocessor`) aggregates metrics into a Count-Min Sketch for estimation of heavy hitters or frequency tracking. It processes incoming metric data points (Gauge, Sum, Histogram) and updates internal row (Metric Name) and column (Host Name) sketches.
