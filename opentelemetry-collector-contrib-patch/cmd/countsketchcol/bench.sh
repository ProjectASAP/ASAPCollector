...
COLLECTOR_BIN="$SCRIPT_DIR/dist/countsketchcol"
CONFIG_FILE="$SCRIPT_DIR/config.yaml"
RESULT_DIR="$WORKSPACE_DIR/otel_collector_benchmark/benchmark_results/countsketchcol"
...
echo "=========================================================="
echo "   COUNTSKETCH PROCESSOR BENCHMARK (Zipf Distribution)"
echo "=========================================================="
